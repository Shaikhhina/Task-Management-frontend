  ...
  return (
    <>
      <div>
        ...
        {data1 && (
          <Cards home={"true"} setClose={setClose} data={data1.tasks} setUpdatedData={setUpdatedData} />
        )}
      </div>
      <InputData close={close} setClose={setClose} updatedData={updatedData} setUpdatedData={setUpdatedData}f/>
    </>
  );
}
